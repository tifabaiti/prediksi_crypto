...
Original file is located at
    https://colab.research.google.com/drive/1ymdrAS-3-pyeaFwBfy5lSeIQlinyJYJa
"""
...
def load_and_process_data(file_path, selected_features):
    ...
    df = df[['Tanggal'] + selected_features]
